...
import (
	...
	enumsSeverities "github.com/ZupIT/horusec-devkit/pkg/enums/severities"
	"github.com/ZupIT/horusec/internal/services/formatters/csharp/scs/severities"
)
...
func (s *ScsResult) GetSeverity() enumsSeverities.Severity {
	if s.ErrorID == "" {
		return enumsSeverities.Unknown
	}

	return s.getVulnerabilityMap()[s.ErrorID]
}

func (s *ScsResult) getVulnerabilityMap() map[string]enumsSeverities.Severity {
	values := map[string]enumsSeverities.Severity{}
