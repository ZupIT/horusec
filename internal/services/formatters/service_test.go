...
func TestMock_AddWorkDirInCmd(t *testing.T) {
	...
	t.Run("Should mock with success", func(t *testing.T) {
		...
		mock.SetMonitor(&monitor.Monitor{})
...
func TestExecuteContainer(t *testing.T) {
	t.Run("should return no error when success set is finished", func(t *testing.T) {
		...
		monitorController := NewFormatterService(analysis, dockerAPIControllerMock, &config.Config{}, &monitor.Monitor{})
...
func TestGetConfigProjectPath(t *testing.T) {
	t.Run("should success get project path", func(t *testing.T) {
		...
		monitorController := NewFormatterService(&entitiesAnalysis.Analysis{}, &docker.Mock{}, cliConfig, &monitor.Monitor{})
...
func TestGetAnalysisID(t *testing.T) {
	t.Run("should success get analysis id", func(t *testing.T) {
		id := uuid.New()
		monitorController := NewFormatterService(&entitiesAnalysis.Analysis{ID: id}, &docker.Mock{}, &config.Config{}, &monitor.Monitor{})
...
func TestSetLanguageIsFinished(t *testing.T) {
	t.Run("should set go as finished", func(t *testing.T) {
		...
		monitorController := NewFormatterService(&entitiesAnalysis.Analysis{}, &docker.Mock{}, &config.Config{}, nil)
		monitorController.SetMonitor(currentMonitor)

		monitorController.SetToolFinishedAnalysis()
		assert.Equal(t, 0, currentMonitor.GetProcess())
	})
}
