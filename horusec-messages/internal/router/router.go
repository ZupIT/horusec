...
import (
	...
	"github.com/ZupIT/horusec/horusec-messages/internal/handlers/health"
	mailerLib "github.com/ZupIT/horusec/horusec-messages/internal/pkg/mailer"
	"github.com/ZupIT/horusec/horusec-messages/internal/router/routes"
...
func (r *Router) RouterHealth(mailer mailerLib.IMailer, broker brokerLib.IBroker) *Router {
	handler := health.NewHandler(mailer, broker)
