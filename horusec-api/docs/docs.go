...
var doc = `{
    ...
    "paths": {
        ...
        "/api/companies/{companyID}/repositories/{repositoryID}/management/{vulnerabilityID}/severity": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "update-vuln-severity",
                "parameters": [
                    {
                        "description": "type of vulnerability",
                        "name": "UpdateVulnSeverity",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateVulnSeverity"
                        }
                    },
                    {
                        "type": "string",
