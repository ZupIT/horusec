...
| HORUSEC_CLI_TOOLS_TO_IGNORE                     | horusecCliToolsToIgnore                    | tools-ignore             | T             |                                         | Used to ignore tool on run horusec analysis. Available are: GoSec,SecurityCodeScan,Brakeman,Safety,Bandit,NpmAudit,YarnAudit,SpotBugs,HorusecKotlin,HorusecJava,HorusecLeaks,GitLeaks,TfSec,Semgrep,HorusecCsharp,HorusecNodeJS. Ex.: `T="GoSec, HorusecLeaks"` |
