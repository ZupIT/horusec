...
### 3. [**Usage**](#usage)
>#### 3.1. [**CLI Usage**](#cli-usage-1)
>#### 3.2. [**Using Docker**](#using-docker-1)
>#### 3.3. [**Older versions**](#older-versions-1)
>#### 3.4. [**Using Horusec-Web application**](#using-horusec-web-application-1)
>#### 3.5.  [**Using Visual Studio Code**](#using-visual-studio-code-1)
