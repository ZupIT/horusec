...
function CheckIfDashboardIsEmpty(): void {
    ...
    cy.wait(5000);
    cy.get("h2").contains("Total developers").parent().contains("1").should("not.exist");
}
...
function CheckIfDashboardNotIsEmpty(): void {
    ...
    cy.get("h2").contains("Total developers").parent().contains("1").should("exist");
    // Check if chart with all vulnerabilities of exists all vulnerabilities
    cy.get("h2").contains("All vulnerabilities").parent().contains("CRITICAL").should("exist");
    cy.get("h2").contains("All vulnerabilities").parent().contains("HIGH").should("exist");
    cy.get("h2").contains("All vulnerabilities").parent().contains("INFO").should("exist");
    cy.get("h2").contains("All vulnerabilities").parent().contains("LOW").should("exist");
    cy.get("h2").contains("All vulnerabilities").parent().contains("MEDIUM").should("exist");
    cy.get("h2").contains("All vulnerabilities").parent().contains("UNKNOWN").should("exist");
    ...
    cy.get("h2").contains("Vulnerabilities by repository").parent().contains("17").should("exist");
    cy.get("h2").contains("Vulnerabilities by repository").parent().contains("57").should("exist");
    cy.get("h2").contains("Vulnerabilities by repository").parent().contains("29").should("exist");
    cy.get("h2").contains("Vulnerabilities by repository").parent().contains("45").should("exist");
    cy.get("h2").contains("Vulnerabilities by repository").parent().contains("16").should("exist");
    cy.get("h2").contains("Vulnerabilities by repository").parent().contains("13").should("exist");
}
...
function CheckIfDashboardNotIsEmptyWithTwoRepositories(repositoryName: string): void {
    ...
    cy.get("h2").contains("Vulnerabilities by developer").parent().contains("17").should("exist");
    cy.get("h2").contains("Vulnerabilities by developer").parent().contains("57").should("exist");
    cy.get("h2").contains("Vulnerabilities by developer").parent().contains("29").should("exist");
    cy.get("h2").contains("Vulnerabilities by developer").parent().contains("45").should("exist");
    cy.get("h2").contains("Vulnerabilities by developer").parent().contains("16").should("exist");
    cy.get("h2").contains("Vulnerabilities by developer").parent().contains("13").should("exist");
}
