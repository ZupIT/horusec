...
import (
	...
	"github.com/ZupIT/horusec/horusec-kotlin/internal/controllers"
	"github.com/spf13/cobra"
)

var rootCmd = &cobra.Command{
	Use:   "horusec-kotlin",
	Short: "Horusec-kotlin CLI",
	RunE: func(cmd *cobra.Command, args []string) error {
		logger.LogPrint("Horusec Kotlin Command Line Interface")
		return cmd.Help()
	},
	Example: `horusec-kotlin run`,
}
