...
func (c *Config) SetRepositoryAuthorization(auth string) {
	c.RepositoryAuthorization = auth
}
...
func (c *Config) SetWorkDir(wd interface{}) {
	if wd != nil {
		c.WorkDir = c.WorkDir.ParseInterfaceToStruct(wd)
	}
	if c.WorkDir == nil {
...
func (c *Config) SetEnableGitHistoryAnalysis(enable bool) {
	c.EnableGitHistoryAnalysis = enable
}
...
func (c *Config) SetCertPath(path string) {
	c.CertPath = path
}
...
func (c *Config) SetEnableCommitAuthor(enable bool) {
	c.EnableCommitAuthor = enable
}
...
func (c *Config) SetHeaders(headers map[string]string) {
	c.Headers = headers
}
...
func (c *Config) SetCustomRulesPath(path string) {
	c.CustomRulesPath = path
}
...
func (c *Config) GetShowVulnerabilitiesTypes() []string {
	return c.ShowVulnerabilitiesTypes
}
...
func (c *Config) SetEnableOwaspDependencyCheck(enable bool) {
	c.EnableOwaspDependencyCheck = enable
}
...
func (c *Config) SetEnableShellCheck(enable bool) {
	c.EnableShellCheck = enable
}
