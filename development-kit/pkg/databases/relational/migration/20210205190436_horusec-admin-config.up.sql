...
(
    ...
    "horusec_keycloak_otp"              VARCHAR(255),
    ...
    "react_app_horusec_endpoint_api"      VARCHAR(255),
    "react_app_horusec_endpoint_analytic" VARCHAR(255),
    "react_app_horusec_endpoint_account"  VARCHAR(255),
    "react_app_horusec_endpoint_auth"     VARCHAR(255),
    "react_app_horusec_manager_path"      VARCHAR(255),
